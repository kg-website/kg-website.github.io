                                ...
                                value: function(t) {
                                    if (!this._breakpoint) {
                                        ...
                                        if ((this.affixedType != e || t) && e) {
                                            ...
                                            for (var r in s.eventTrigger(this.sidebar, o), "STATIC" === e ? s.removeClass(this.sidebar, this.options.stickyClass) : s.addClass(this.sidebar, this.options.stickyClass), n.outer) this.sidebar.style[r] = n.outer[r];
