                ...
                i.prototype = {
                    _init: function() {
                        ...
                        if (e.querySelector) {
                            ...
                            void 0 !== n && o._content_set(n), o.$el.removeAttr("title").addClass("tooltipstered"), !a && o.options.iconDesktop || a && o.options.iconTouch ? ("string" == typeof o.options.icon ? (o.$elProxy = t('<span class="' + o.options.iconTheme + '"></span>'), o.$elProxy.text(o.options.icon)) : o.options.iconCloning ? o.$elProxy = o.options.icon.clone(!0) : o.$elProxy = o.options.icon, o.$elProxy.insertAfter(o.$el)) : o.$elProxy = o.$el, "hover" == o.options.trigger ? (o.$elProxy.on("mouseenter." + o.namespace, (function() {
                            ...
                            })), a && o.options.touchDevices && o.$elProxy.on("touchstart." + o.namespace, (function() {
                                o._showNow()
                        ...
                        i.options.functionBefore.call(i.$el, i.$el, (function() {
                            if (i.enabled && null !== i.Content) {
                                ...
                                if ("hidden" !== i.Status) {
                                    ...
                                    i.Status = "appearing", s = i.options.speed, i.bodyOverflowX = t("body").css("overflow-x"), t("body").css("overflow-x", "hidden");
                                    ...
                                    if (i.$tooltip = t('<div class="tooltipster-base ' + i.options.theme + '" style="' + f + " " + d + " " + c + " " + p + '"><div class="tooltipster-content"></div></div>'), r() && i.$tooltip.addClass(l), i._content_insert(), i.$tooltip.appendTo("body"), i.reposition(), i.options.functionReady.call(i.$el, i.$el, i.$tooltip), r() ? (i.$tooltip.addClass(l + "-show"), i.options.speed > 0 && i.$tooltip.delay(i.options.speed), i.$tooltip.queue(n)) : i.$tooltip.css("display", "none").fadeIn(i.options.speed, n), i._interval_set(), t(o).on("scroll." + i.namespace + " resize." + i.namespace, (function() {
                                            i.reposition()
                                        })), i.options.autoClose)
                                        if (t("body").off("." + i.namespace), "hover" == i.options.trigger) {
                                            if (a && setTimeout((function() {
                                                ...
                                                a && i.$tooltip.on("touchstart." + i.namespace, (function(t) {
                                                    t.stopPropagation()
                                                }));
                                                var h = null;
                    ...
                    reposition: function() {
                        ...
                        if (0 !== t("body").find(e.$tooltip).length) {
                            ...
                            if ("top-left" == H && (_ = s.offset.left + O, I = s.offset.top - l - S - 12, M(), D("bottom-left", "top-left")), "top-right" == H && (_ = s.offset.left + s.dimension.width + O - r, I = s.offset.top - l - S - 12, M(), D("bottom-right", "top-right")), "bottom" == H && (W = s.offset.left + r - (s.offset.left + s.dimension.width), _ = s.offset.left - W / 2 + O, I = s.offset.top + s.dimension.height + S + 12, M(), D("top", "bottom")), "bottom-left" == H && (_ = s.offset.left + O, I = s.offset.top + s.dimension.height + S + 12, M(), D("top-left", "bottom-left")), "bottom-right" == H && (_ = s.offset.left + s.dimension.width + O - r, I = s.offset.top + s.dimension.height + S + 12, M(), D("top-right", "bottom-right")), "left" == H) {
                            ...
                            if ("right" == H && (_ = s.offset.left + O + s.dimension.width + 12, k = s.offset.left - O - r - 12, A = s.offset.top + l - (s.offset.top + s.dimension.height), I = s.offset.top - A / 2 - S, _ + r > n && k < 0 ? (z = 2 * parseFloat(e.$tooltip.css("border-width")), F = n - _ - z, e.$tooltip.css("width", F + "px"), l = e.$tooltip.outerHeight(!1), A = s.offset.top + l - (s.offset.top + s.dimension.height), I = s.offset.top - A / 2 - S) : _ + r > n && (_ = s.offset.left - O - r - 12, i = "right")), e.options.arrow) {
                                var N = "tooltipster-arrow-" + H;
                                if (e.options.arrowColor.length < 1) var X = e.$tooltip.css("background-color");
                                else X = e.options.arrowColor;
                                if (i ? "left" == i ? (N = "tooltipster-arrow-right", i = "") : "right" == i ? (N = "tooltipster-arrow-left", i = "") : i = "left:" + Math.round(i) + "px;" : i = "", "top" == H || "top-left" == H || "top-right" == H) var q = parseFloat(e.$tooltip.css("border-bottom-width")),
                                    j = e.$tooltip.css("border-bottom-color");
                                else "bottom" == H || "bottom-left" == H || "bottom-right" == H ? (q = parseFloat(e.$tooltip.css("border-top-width")), j = e.$tooltip.css("border-top-color")) : "left" == H ? (q = parseFloat(e.$tooltip.css("border-right-width")), j = e.$tooltip.css("border-right-color")) : "right" == H ? (q = parseFloat(e.$tooltip.css("border-left-width")), j = e.$tooltip.css("border-left-color")) : (q = parseFloat(e.$tooltip.css("border-bottom-width")), j = e.$tooltip.css("border-bottom-color"));
                                q > 1 && q++;
                                var E = "";
                                if (0 !== q) {
                                    var L = "",
                                ...
                                var U = '<div class="' + N + ' tooltipster-arrow" style="' + i + '">' + E + '<span style="border-color:' + X + ';"></span></div>';
                                e.$tooltip.append(U)
                            }
                            e.$tooltip.css({
                                top: Math.round(I) + "px",
